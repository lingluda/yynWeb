...
.tits{line-height: 60px;font-size: 16px;padding-left: 20px;font-weight: 600;color: #000;background: #fff;border-bottom: 1px solid #e2e4e6}
...
.card_title{line-height:30px;height:40px;font-size:15px}
.tousimg_zb{width: 100%;height: 400px;border: 1px solid #dcdee2;padding:0 30px 15px;}
</style>
